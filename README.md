...
- [Role Variables](#role-variables)
  ...
  - [Examples of configuration](#examples-of-configuration)
    - [zabbix\_repo\_yum](#zabbix_repo_yum)
- [Dependencies](#dependencies)
- [Example Playbook](#example-playbook)
  - [Single instance](#single-instance)
  - [Multi host setup](#multi-host-setup)
  - [Adding Environment Variables for zabbix\_web](#adding-environment-variables-for-zabbix_web)
...
This role based on https://github.com/dj-wasabi/ansible-zabbix-web
